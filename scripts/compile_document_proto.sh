...
javac -classpath "${DEPENDENCY_PATH}/protobuf/java/core/target/protobuf-java-3.0.2.jar" \
...
--proto_path=${ROOT_PATH}/proto --grpc-java_out=${ROOT_PATH}/protolib/java --java_out=${ROOT_PATH}/protolib/java \
${ROOT_PATH}/proto/rpc.proto
javac -classpath "${DEPENDENCY_PATH}/protobuf/java/core/target/protobuf-java-3.0.2.jar:${ROOT_PATH}/protolib/java" \

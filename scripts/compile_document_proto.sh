...
javac -classpath "../dep/protobuf/java/target/protobuf-java-3.0.0-beta-1.jar" ../protolib/java/edu/delaware/nlp/DocumentProto.java
...
javac -classpath "../dep/protobuf/java/target/protobuf-java-3.0.0-beta-1.jar:../protolib/java/" ../protolib/java/edu/delaware/nlp/RpcProto.java
